...
<html class="no-js" lang="zxx">
    ...
    <body>
                            ...
                            <div class="main-menu text-center">
                                <nav>
                                    <ul>
                                        ...
                                        <li class="mega-menu-position"><a href="{{ route('products-list') }}">Food</a>
                                            <ul class="mega-menu">
                                                <li>
                                                    <ul>
                                                        <li class="mega-menu-title"><a href="{{ route('products-list', ['category' => 'dogs-food']) }}">Dogs Food</a></li>
                                                        <li><a href="{{ route('products-list', ['category' => 'dogs-food', 'sub_category' => 'eggs']) }}">Eggs</a></li>
                                                        <li><a href="{{ route('products-list', ['category' => 'dogs-food', 'sub_category' => 'carrots']) }}">Carrots</a></li>
                                                        <li><a href="{{ route('products-list', ['category' => 'dogs-food', 'sub_category' => 'salmon-fishs']) }}">Salmon fishs</a></li>
                                                        <li><a href="{{ route('products-list', ['category' => 'dogs-food', 'sub_category' => 'peanut-butter']) }}">Peanut Butter</a></li>
                                                        <li><a href="{{ route('products-list', ['category' => 'dogs-food', 'sub_category' => 'grapes-end-raisins']) }}">Grapes end Raisins</a></li>
                                                    </ul>
                                                </li>
                                                <li>
                                                    <ul>
                                                        <li class="mega-menu-title"><a href="{{ route('products-list', ['category' => 'cats-food']) }}">Cats Food</a></li>
                                                        <li><a href="{{ route('products-list', ['category' => 'cats-food', 'sub_category' => 'meat']) }}">Meat</a></li>
                                                        <li><a href="{{ route('products-list', ['category' => 'cats-food', 'sub_category' => 'fish']) }}">Fish</a></li>
                                                        <li><a href="{{ route('products-list', ['category' => 'cats-food', 'sub_category' => 'eggs']) }}">Eggs</a></li>
                                                        <li><a href="{{ route('products-list', ['category' => 'cats-food', 'sub_category' => 'veggies']) }}">Veggies</a></li>
                                                        <li><a href="{{ route('products-list', ['category' => 'cats-food', 'sub_category' => 'cheese']) }}">Cheese</a></li>
                                                    </ul>
                                                </li>
                                                <li>
                                                    <ul>
                                                        <li class="mega-menu-title"><a href="{{ route('products-list', ['category' => 'fishs-food']) }}">Fishs Food</a></li>
                                                        <li><a href="{{ route('products-list', ['category' => 'fishs-food', 'sub_category' => 'rice']) }}">Rice</a></li>
                                                        <li><a href="{{ route('products-list', ['category' => 'fishs-food', 'sub_category' => 'veggies']) }}">Veggies</a></li>
                                                        <li><a href="{{ route('products-list', ['category' => 'fishs-food', 'sub_category' => 'cheese']) }}">Cheese</a></li>
                                                        <li><a href="{{ route('products-list', ['category' => 'fishs-food', 'sub_category' => 'wheat-bran']) }}">wheat bran</a></li>
                                                        <li><a href="{{ route('products-list', ['category' => 'fishs-food', 'sub_category' => 'cultivation']) }}">Cultivation</a></li>
                                                    </ul>
                                                </li>
                                                <li>
                                                    <ul>
                                                        <li><a href="{{ route('products-list', ['category' => 'dogs-food', 'sub_category' => 'carrots']) }}"><img alt="" src="{{ asset("img/banner/menu-img-4.jpg") }}"></a></li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        </li>
                                        <li><a href="#">PAGES</a>
                                            <ul class="submenu">
                                                ...
                                                <li>
                                                    <a href="{{ route('products-list', ['category' => 'dogs-food', 'sub_category' => 'carrots']) }}">shop page</a>
                                                </li>
                                                <li>
                                        ...
                                        <li><a href="#">Food</a>
                                            <ul>
                                                <li><a href="#">Dogs Food</a>
                                                    <ul>
                                                        <li><a href="{{ route('products-list', ['category' => 'dogs-food', 'sub_category' => 'carrots']) }}">Grapes and Raisins</a></li>
                                                        <li><a href="{{ route('products-list', ['category' => 'dogs-food', 'sub_category' => 'carrots']) }}">Carrots</a></li>
                                                        <li><a href="{{ route('products-list', ['category' => 'dogs-food', 'sub_category' => 'carrots']) }}">Peanut Butter</a></li>
                                                        <li><a href="{{ route('products-list', ['category' => 'dogs-food', 'sub_category' => 'carrots']) }}">Salmon fishs</a></li>
                                                        <li><a href="{{ route('products-list', ['category' => 'dogs-food', 'sub_category' => 'carrots']) }}">Eggs</a></li>
                                                    </ul>
                                                </li>
                                                <li><a href="#">Cats Food</a>
                                                    <ul>
                                                        <li><a href="{{ route('products-list', ['category' => 'dogs-food', 'sub_category' => 'carrots']) }}">Meat</a></li>
                                                        <li><a href="{{ route('products-list', ['category' => 'dogs-food', 'sub_category' => 'carrots']) }}">Fish</a></li>
                                                        <li><a href="{{ route('products-list', ['category' => 'dogs-food', 'sub_category' => 'carrots']) }}">Eggs</a></li>
                                                        <li><a href="{{ route('products-list', ['category' => 'dogs-food', 'sub_category' => 'carrots']) }}">Veggies</a></li>
                                                        <li><a href="{{ route('products-list', ['category' => 'dogs-food', 'sub_category' => 'carrots']) }}">Cheese</a></li>
                                                    </ul>
                                                </li>
                                                <li><a href="#">Fishs Food</a>
                                                    <ul>
                                                        <li><a href="{{ route('products-list', ['category' => 'dogs-food', 'sub_category' => 'carrots']) }}">Rice</a></li>
                                                        <li><a href="{{ route('products-list', ['category' => 'dogs-food', 'sub_category' => 'carrots']) }}">Veggies</a></li>
                                                        <li><a href="{{ route('products-list', ['category' => 'dogs-food', 'sub_category' => 'carrots']) }}">Cheese</a></li>
                                                        <li><a href="{{ route('products-list', ['category' => 'dogs-food', 'sub_category' => 'carrots']) }}">wheat bran</a></li>
                                                        <li><a href="{{ route('products-list', ['category' => 'dogs-food', 'sub_category' => 'carrots']) }}">Cultivation</a></li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        </li>
		...
		<div class="testimonial-area pt-90 pb-70 bg-img" style="background-image:url({{ asset("img/banner/banner-2.png") }});">
		    <div class="container">
                <div class="row">
                            ...
                            <div class="quick-view-learg-img">
                                <div class="quick-view-tab-content tab-content">
                                    ...
                                    <div class="tab-pane fade" id="modal3" role="tabpanel">
                                        <img src="{{ asset("img/quick-view/l3.jp") }}" alt="">
                                    </div>
                                </div>
                            </div>
